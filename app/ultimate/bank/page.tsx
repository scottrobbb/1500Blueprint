...
export default async function UltimateQuestionBankPage() {
  ...
  return <QuestionBankDashboardView dashboard={dashboard} access={{ plan: access.plan, test: access.isTestAccount, used, limit: access.entitlements.questionBankLimit, challengeQuestions: access.entitlements.challengeQuestions, isAdmin: isAdminEmail(session.email) }} />;
}
