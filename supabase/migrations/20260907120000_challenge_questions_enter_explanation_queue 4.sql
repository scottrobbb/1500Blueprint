...
--
-- The queue was built before Challenge was a difficulty. It carried
-- `lower(q.difficulty) in ('easy','medium','hard')`, which at the time meant
-- "everything", and the tier arrived on 2026-09-01 as a fourth value that
-- silently fell outside it. Every Challenge question missing an explanation
-- has been invisible to Content Operations since.
--
-- Five functions share that gate, and opening only the queue would have been
